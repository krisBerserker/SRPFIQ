...
namespace WebApplication_SRPFIQ.Migrations
{
    ...
    [Migration("20250717132710_FixResourceCategoryName")]
    partial class FixResourceCategoryName
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApplication_SRPFIQ.Models.Resources", b =>
                {
                    ...
                    b.Property<int>("IdResourceCategorie")
                        .HasColumnType("int")
                        .HasColumnName("IdResourceCategorie");
                    ...
                    b.HasIndex("IdResourceCategorie");
            ...
            modelBuilder.Entity("WebApplication_SRPFIQ.Models.Resources", b =>
                {
                    b.HasOne("WebApplication_SRPFIQ.Models.ResourceCategories", "ResourceCategories")
                        .WithMany("Resources")
                        .HasForeignKey("IdResourceCategorie")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("WebApplication_SRPFIQ.Models.Resources_ResourceCategories", b =>
                {
                    ...
                    b.HasOne("WebApplication_SRPFIQ.Models.ResourceCategories", "ResourceCategorie")
                        .WithMany()
                        .HasForeignKey("IdResourceCategorie")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("ResourceCategorie");
                });
