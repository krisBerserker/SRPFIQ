...
{
    /// <inheritdoc />
    public partial class FixResourceCategoryName : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdResourceCategorie = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Resources", x => x.ID);
                    table.ForeignKey(
                        name: "FK_Resources_ResourceCategories_IdResourceCategorie",
                        column: x => x.IdResourceCategorie,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Resources_ResourceCategories_ResourceCategories_IdResourceCategorie",
                        column: x => x.IdResourceCategorie,
                        principalTable: "ResourceCategories",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Resources_IdResourceCategorie",
                table: "Resources",
                column: "IdResourceCategorie");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Resources_ResourceCategories_IdResourceCategorie",
                table: "Resources_ResourceCategories",
                column: "IdResourceCategorie");
